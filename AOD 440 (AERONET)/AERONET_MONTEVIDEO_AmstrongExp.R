...
path_Aeronet <- "C:/Users/Fer/OneDrive/FERNANDA/DOCTORADO/TRABAJOS/Prueba_DSCOVR_EPIC_MAIAC/AERONET_MONTEVIDEO/"

# Define the file paths in a list
file_paths <- c(
  paste(path_Aeronet, '20200101_20201231_Montevideo_FING.lev20', sep = ""),
  paste(path_Aeronet, '20210101_20211231_Montevideo_FING.lev20', sep = ""),
  paste(path_Aeronet, '20220101_20221231_Montevideo_FING.lev20', sep = "")
)
...
if (all(Angstrom_Exponent$Data_Quality_Level == "lev20")) {
...
Angstrom_Exponent$year <- as.numeric(substr(Angstrom_Exponent$`Date(dd:mm:yyyy)`, 7, 10))

# Re-arrange Angstrom_Exponent
...
write.csv(Angstrom_Exponent, 
          file = "C:/Users/Fer/OneDrive/FERNANDA/DOCTORADO/TRABAJOS/Prueba_DSCOVR_EPIC_MAIAC/OUTPUT_CSV/AERONET_MONTEVIDEO_Angstrom_Exponent.csv",
          row.names = FALSE)

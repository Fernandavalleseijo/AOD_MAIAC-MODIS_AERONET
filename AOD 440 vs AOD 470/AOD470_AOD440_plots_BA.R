...
# WARNING: "AOD440_AOD470_25km_Ceilap.csv" from MAIAC_MODIS_25km_CEILAP.R has to be created to use this code!!
...
filtered_result <- read.csv(paste0(csv_path, "AOD440_AOD470_25km_Ceilap.csv"), sep = ",")
...
Plot_AllData <- ggplot(ideal, aes(x = x, y = y)) +
  ...
  coord_cartesian(
    ...
    ylim =  c(0, 2))+
  labs(
    x = "AOD 440 (AERONET - Buenos Aires (CEILAP))",
...
ggsave(Plot_AllData,
       path = plots_path, 
       filename = "AOD470_AOD440-BA_total.png", 
...
ggsave(Plot_bySat,
       path = plots_path, 
       filename = "AOD470_AOD440-BA_satellite.png", 
...
ggsave(Plot_byYear,
       path = plots_path, 
       filename = "AOD470_AOD440-BA_year.png", 
